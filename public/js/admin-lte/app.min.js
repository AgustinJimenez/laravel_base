...
function App() {
    ...
    var template_container_class = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : ".template-content-container";
    ...
    app.response = '';
    app.datatables_list = [];
    app.get_template_content_container = function () {
        return $(template_container_class);
    };
    app.buttons = {
    ...
    */
    ...
    app.confirm = function () {
        ...
        var title = arguments.length > 8 && arguments[8] !== undefined ? arguments[8] : 'CONFIRMACIÓN';
    ...
    app.response_error_handler = function () {
        ...
        switch (type) {
            case "default":
                ...
                var errors = [];
                if (app.response != undefined && app.response.error == true) if (app.response.messages != undefined) if (typeof app.response.messages == "string") app.toast(app.response.messages);else if (_typeof(app.response.messages) == "object") {
                ...
                } else if (app.response != undefined && app.response.messages != undefined) app.alert(app.response.messages, 'warning');else app.toast("Ocurrio un error inesperado.");
    ...
    app.http = function () {
        ...
        $.ajax({
            ...
            success: function success(data, textStatus, jQxhr) {
                ...
                if (data === undefined && app.debug) app.toast("Resonpones is undefined");

                app.response = data;

                if (app.debug && false) console.log("GETTING", app.response);
    ...
    app.toast = function (text) {
        var icon = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 'error';
        var heading = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 'Warning';
        var Loader_bg = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : '#9EC600';
        var loader = arguments.length > 4 && arguments[4] !== undefined ? arguments[4] : true;
        var hideAfter = arguments.length > 5 && arguments[5] !== undefined ? arguments[5] : 5000;
        var allowToastClose = arguments.length > 6 && arguments[6] !== undefined ? arguments[6] : true;
        var stack = arguments.length > 7 && arguments[7] !== undefined ? arguments[7] : 4;
    ...
    app.actions = {
        ...
        refresh_content: function refresh_content() {
            if (debug) console.log("RUNNING REFRESH-CONTENT / CONTENT===>", app.response.length);
            //REFRESH-CONTENT
            if (app.response === undefined) app.toast("No content to refreh.");
    ...
    app.set_dynamic_content = function () {
        ...
        $(document).on('click', "a[href!='#']", function (event) {
            ...
            if (app.debug) console.log("clicked===>", clicked_link);
